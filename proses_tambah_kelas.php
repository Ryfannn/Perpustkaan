...
if($_POST){
    ...
    if (empty($nama_kelas)){
        ...
        if($insert){
            echo "<script>alert('Sukses mengirimkan data');location.href='tambah_kelas.php';</script>";
        } else {
            echo "<script>alert('Gagal mengirimkan data');location.href='tambah_kelas.php';</script>";
        }
    }
}
?>